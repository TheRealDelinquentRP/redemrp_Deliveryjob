...
Config.DeliverySprite = -695368421 -- Point Sprite
Config.ShowBlips = true -- Show Point blips

--Messages
Config.Deliver = "Press (E) to make a delivery" -- Start Gathering Message
Config.TimerMsg = "Delivering" -- Finish message

--Timer and zone size
Config.DeliveryTime = 10000 -- Time it takes to deliver (10 seconds)
Config.ZoneSize = 2.0 -- Sizes of the zones

--Point specifics

--Valentine to Fort Wallace
Config.MainJob1 = {x=-326.08,y=805.85,z=117.88} -- Job1 Position Valentine
Config.Point1 = {x=367.17,y=1471.6,z=180.22} -- Point 1 location Fort Wallace
Config.StartWorking1 = "Press (E) to take supplies to Fort Wallace." -- Start Working Message
Config.Cash1 = 5 -- Cash payout
Config.Exp1 = 1 -- EXP payout
...
Config.Gold4 = 2 -- Gold payoutConfig = {}
